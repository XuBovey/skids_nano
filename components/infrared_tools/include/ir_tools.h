...
struct ir_builder_s {
    ...
    */
     ...
     * xubh 2021-9-3
    */
    esp_err_t (*make_connect)(ir_builder_t *builder);
    esp_err_t (*build_frame_ext)(ir_builder_t *builder, uint8_t *data0, uint8_t *data1, uint16_t data0_bits, uint16_t data1_bits, uint8_t connect_en);
...
struct ir_parser_s {
    ...
    */
    ...
    esp_err_t (*get_scan_code_ext)(ir_parser_t *parser, uint8_t *data0, uint8_t *data1, uint8_t *data0_len, uint8_t *data1_len, uint8_t item_num);
    /**
